    ...
    <div style="display: flex; height: 2.5rem;padding-top: 0.5rem;background: url(https://adn-static1.nykaa.com/media/wysiwyg/2021/topstrips18.jpg);" class="header-top">
        ...
        <div style="display: flex; border: 1px solid rgba(174,174,174,0.5);justify-content: space-evenly;min-height: 2rem;padding: 1rem;" class="header-bottom">
                ...
                <ul style="display: flex;list-style: none;min-width: 70vw;justify-content: space-evenly;color: #949090;">
                    <li onmouseover="show1()"  onmouseleave="hide1()"><a href="">Makeup</a></li>
                    <li onmouseover="show2()" onmouseleave="hide2()"><a href="">Skin</a></li>
                    <li onmouseover="show3()" onmouseleave="hide3()"><a href="">Hair</a></li>
                    <li onmouseover="show4()" onmouseleave="hide4()"><a href="">Appliances</a></li>
                    <li onmouseover="show5()" onmouseleave="hide5()"><a href="">Personal Care</a></li>
                    <li onmouseover="show6()" onmouseleave="hide6()"><a href="">Natural</a></li>
                    <li onmouseover="show7()" onmouseleave="hide7()"><a href="">Mom & Baby</a></li>
                    <li onmouseover="show8()" onmouseleave="hide8()"><a href="">Health & Wellness</a></li>
